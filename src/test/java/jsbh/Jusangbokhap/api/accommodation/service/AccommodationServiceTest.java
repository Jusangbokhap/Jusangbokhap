...
class AccommodationServiceTest {
    ...
    void 숙소_생성_성공_유효한_요청() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 100000, "HOTEL", 1, 1);
    ...
    void 숙소_생성_실패_최대인원_1명미만_예외발생() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 100000, "HOTEL", 0, 1);
    ...
    void 숙소_생성_실패_최대인원_100명초과_예외발생() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 100000, "HOTEL", 101, 1);
        assertThrows(AccommodationCustomException.class, () -> accommodationService.create(request));
    }
    ...
    void 숙소_생성_실패_최소가격_미만_예외발생() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 0, "HOTEL", 100, 1);
        assertThrows(AccommodationCustomException.class, () -> accommodationService.create(request));
    }
    ...
    void 숙소_생성_실패_최대가격_초과_예외발생() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 10000001, "HOTEL", 100, 1);
        assertThrows(AccommodationCustomException.class, () -> accommodationService.create(request));
    }
    ...
    void 숙소_생성_실패_잘못된_숙소타입_예외발생() {
        Create request = createAccommodationRequest("name","경기도", "경기도 호텔", 100, "NULL", 1, 1);
        assertThrows(AccommodationCustomException.class, () -> accommodationService.create(request));
    }
    ...
    void 숙소_생성_실패_예약날짜_겹침_예외발생() {
        ...
        Create request = new Create("name","경기도", "경기도 호텔", 100, "HOTEL", 1, 1, availableDateRequests);
    ...
    private Create createAccommodationRequest(String name, String address, String des, int price, String type, int people,
                                              int userId) {
        LocalDate startDate = LocalDate.of(2025, 2, 1);
